...
const Signup = () => {
  ...
  return (
    <div className="signup text-black max-w-4xl mx-auto p-6 border-[1px] border-gray-300 rounded-xl bg-white shadow-md">
      <h2 className="text-3xl font-bold mb-4 text-center text-[#3A843A]">
        Sign Up
      </h2>
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <div className="flex space-x-4">
          <div className="w-1/2">
            ...
            <input
              className="mt-1 block w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#3A843A]"
              type="text"
              id="username"
              name="username"
        ...
        <button
          className="mt-6 w-full bg-[#3A843A] text-white p-2 rounded-md hover:bg-green-700 focus:ring-2 focus:ring-green-500"
          type="submit"
        >
          Sign Up
        </button>
